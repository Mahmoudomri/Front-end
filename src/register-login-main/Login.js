...
import illustration from "../images-main/loginbg-ill.png";
import logo from "../images-main/logo.png";
import googleIconImageSrc from "../images-main/google-icon.png";
import twitterIconImageSrc from "../images-main/twitter-icon.png";
import { ReactComponent as LoginIcon } from "feather-icons/dist/icons/log-in.svg";
import AnimationRevealPage from "../components/helpers/AnimationRevealPage";
import logo1 from "../images/mahmoud2.jpg";
...
export const Login = ({
  ...
  headingText = "Sign In to Waste Not",
  socialButtons = [
    {
      ...
      <Container>
        <Content>
          ...
          <IllustrationContainer>
            <IllustrationImage imageSrc={logo1} />
          </IllustrationContainer>
        </Content>
      </Container>
    </AnimationRevealPage>
